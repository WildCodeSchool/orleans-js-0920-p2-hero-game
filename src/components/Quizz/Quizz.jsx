...
function Quizz() {
  ...
  const questions = [
    ...
    {
      questionText:
        "Un voyou embête une fille dans une rue animée du centre-ville! Que faîtes-vous ?",
      answerOptions: [
    ...
    {
      questionText:
        "Vous recevez un paquet cadeau! Mais vous ne savez pas ce qu'il y a dedans. Que faîtes-vous ?",
      answerOptions: [
    ...
    {
      questionText:
        "C'est le week-end, mais personne ne veut jouer avec vous... Que faîtes-vous ?",
      answerOptions: [
    ...
    {
      questionText:
        "Vous avez un examen très important demain ! Que faîtes-vous ?",
      answerOptions: [
